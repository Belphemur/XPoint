  ...
  static const std::vector<SettingInfo> baseList = [] {
    ...
    std::vector<SettingInfo> v = {
        ...
        SettingInfo::Enum(StrId::STR_FONT_FAMILY, &CrossPointSettings::fontFamily,
                          {StrId::STR_NOTO_SERIF, StrId::STR_ATKINSON_HN, StrId::STR_ATKINSON_HN}, "fontFamily",
        ...
        SettingInfo::Toggle(StrId::STR_EXTRA_SPACING, &CrossPointSettings::extraParagraphSpacing,
            ...
            .withTextSettings(),
        SettingInfo::Enum(StrId::STR_TEXT_RENDERING, &CrossPointSettings::textRenderMode,
                          {StrId::STR_SMOOTH, StrId::STR_CRISP}, "textRenderMode", StrId::STR_CAT_READER)
            .withTextSettings(),
        ...
        SettingInfo::Enum(StrId::STR_TOUCH_LONG_PRESS, &CrossPointSettings::touchLongPressAction,
                          {StrId::STR_DICTIONARY, StrId::STR_IGNORE, StrId::STR_FOOTNOTES}, "touchLongPressAction",
                          StrId::STR_CAT_CONTROLS),
        ...
        SettingInfo::Value(StrId::STR_AUTO_POWER_OFF, &CrossPointSettings::autoPowerOffHours,
        ...
        SettingInfo::Enum(StrId::STR_CLOCK_FORMAT, &CrossPointSettings::clockFormat,
                          ...
                          StrId::STR_CUSTOMISE_STATUS_BAR),
        // Device UI edits this in the Clock settings menu (System > Clock).
        SettingInfo::Toggle(StrId::STR_HEADER_CLOCK, &CrossPointSettings::headerClock, "headerClock",
                            StrId::STR_CUSTOMISE_STATUS_BAR),
